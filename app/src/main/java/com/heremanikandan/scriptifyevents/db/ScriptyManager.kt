    ...
    @Database(entities = [User::class,Event::class, Reminder::class,SharedWith::class,Participant::class,Attendance::class], version = 2, exportSchema = false)
    ...
    object ScriptyManager {
        ...
        fun getInstance(context: Context): ScriptifyBase {
            synchronized(this) {
               // context.deleteDatabase("scriptifyEventsData")
